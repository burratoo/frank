...
--     end USART_Interface_0;
   ...
   protected body USART_Interface_1 is
      ...
      begin
         ...
         --  Setup the USART to send the message if there is one to send
         ...
         --  Configure the USART to receive a message if we are expecting one
      ...
      procedure Interface_Handler is
      begin
         --  Once the send and receive transfers have completed disable the interrupts
         --  and flag the transfer as completed.

         if USART (1).Channel_Status_Register.End_Of_Transmitter_Transfer
           and USART (1).Channel_Status_Register.End_Of_Receive_Transfer
         then
         ...
         --  If we have a time out abandon the transfer
      ...
      begin
         ...
         --  Unblock any task that might have been waiting for a transfer
