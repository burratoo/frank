------------------------------------------------------------------------------------------
--                                                                                      --
--                                MINDSTORMS.NXT.LCD.FONT                               --
--                                                                                      --
--                         Copyright (C) 2014-2021, Pat Bernardi                        --
--                                                                                      --
------------------------------------------------------------------------------------------

package Mindstorms.NXT.LCD.Font is

   subtype Glyph_Image is LCD_Line (0 .. 4);

   Font5x8 : constant array (Character range ' ' .. '~') of Glyph_Image :=
               (
